...
CRF & \textbf{C}omoving \textbf{R}est \textbf{F}rame \\
EFE & \textbf{E}instein \textbf{F}ield \textbf{E}quations \\
EMRI & \textbf{E}xtreme \textbf{Mass} \textbf{R}atio \textbf{I}nspiral \\
FLRW & \textbf{F}riedmann-\textbf{L}emaître-\textbf{R}obertson-\textbf{W}alker \\
...
ONERA & \textbf{O}ffice \textbf{N}ational d’\textbf{E}tudes et \textbf{R}echerches \textbf{A}érospatiales\\
