...
Systems comprising two compact objects, either two black holes (BBH), two neutron stars (BNS), or one black hole and one neutron star (BH-NS), spiral inward due to the emission of gravitational radiation and eventually merge. During the final inspiral and merger, the GW amplitude increases rapidly, producing a characteristic “chirp” waveform that lasts from milliseconds to minutes depending on masses and detector sensitivity. These events are the dominant type detected by Advanced LIGO and Virgo so far, including the first-ever detection GW150914 and the binary neutron star event GW170817.

To date, nearly all confirmed detections belong to the compact binary coalescence class. As of the latest catalog GWTC‑4, there are around 218 confirmed GW events from LIGO and Virgo spanning multiple observing runs.
