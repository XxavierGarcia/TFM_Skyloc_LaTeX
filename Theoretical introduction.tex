...
This is exploited through a coherent joint parameter 
estimation of the two images: under the lensed 
hypothesis $\mathcal{H}_L$, both data streams $d_1$ 
...
thesis. The following chapters describe the simulation 
setup, the parameter estimation pipeline, and the sky 
localization analysis carried out on a population of 
500 strongly lensed BBH events.
