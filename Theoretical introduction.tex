...
minima and maxima of $\tau$ have positive magnification, while images at saddle points have negative magnification (i.e. they are mirror-inverted). For the point mass lens, the magnifications of the two images are
\begin{equation}
...
unlensed ray by two contributions. The geometric delay arises from the longer path length of the deflected ray, while the Shapiro delay \cite{} results from the slowing of the signal in the gravitational potential of the lens. Together, they yield the time delay between two images $i$ and $j$
\begin{equation}
...
redshifting of the delay at the lens. For galaxy-scale lenses, $\Delta t_{ij}$ ranges from minutes to months \cite{}, and constitutes one of the key observables in GW lensing searches.
