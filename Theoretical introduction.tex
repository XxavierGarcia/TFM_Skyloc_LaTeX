...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.67\linewidth]{Figures/narrow_lines.png}
    \caption{Source: \cite{glitches_lines_noises}.}
    \label{fig:lines_noise}
\end{figure}


Glitches are short-duration transient bursts of excess power whose morphology can mimic astrophysical signals, reducing the efficiency of detection pipelines \cite{Glitches}.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.67\linewidth]{Figures/glitches.png}
    \caption{Source: \cite{glitches_lines_noises}.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.76\linewidth]{Figures/noise_budget_O4_LLO.png}
