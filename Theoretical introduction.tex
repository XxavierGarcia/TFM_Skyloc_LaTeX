...
\nabla_\mu T^{\mu\nu} = 0 \ ,
\end{equation}
which ensures that energy and momentum are locally conserved for any physically meaningful system. In flat spacetime this reduces to $\partial_\mu T^{\mu\nu} = 0$, encompassing both energy and momentum conservation, while in curved spacetime the covariant form remains valid without modification.
