...
Technical noise is not intrinsic to the design but still limits performance. The main contributions are the following \cite{noise_aLIGO,noise_budget_O4}:
