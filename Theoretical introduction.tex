...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.77\linewidth]{Figures/light_deflection}
...
\end{equation}
which sets the characteristic angular scale of lensing. For a general source position, the lens equation reduces to a quadratic in $|\boldsymbol{\theta}|$, always producing exactly two images at positions
\begin{equation}
...
\begin{equation}
    ...
    \right],
\end{equation}
where $M_{Lz} = M_L(1+z_L)$ is the redshifted lens mass. 
