...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{Figures/narrow_lines.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{Figures/Runs_timeline.png}
    \caption{. Source: \cite{runs_timeline_O1234}.}
