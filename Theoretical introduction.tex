...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.83\linewidth]{Figures/narrow_lines.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/noise_budget_O4_LLO.png}
...
\begin{itemize}
    ...
    \item \textbf{Advanced Virgo (V1)} \cite{Advanced_VIRGO} is a 3-km interferometer located in Cascina, Italy, operated by the Virgo Collaboration. It joined the network in the final month of O2, contributing to the first three-detector observation of a binary black hole merger (GW170814) and to the precise sky localisation of the binary neutron star merger GW170817 \cite{GW170817}. Although its sensitivity is somewhat below that of the LIGO instruments, its geographic separation from the US sites significantly improves source localisation.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.82\linewidth]{Figures/current_network_interferometers.png}
