...
\cite{CNES_MICROSCOPE_eoportal, MicroSCOPE2022final}.
...
original unmodified equations. Einstein reportedly referred to the cosmological constant as ``the biggest blunder'' of his life, as described by \href{https://es.wikipedia.org/wiki/Gueorgui_G%C3%A1mov}{George Gamow}, though the remark is not documented in Einstein's own writing.
...
and Penrose showed in 1965 that such singularities necessarily exist inside any closed trapped surface \cite{Penrose1969}.
...
\begin{equation}
ct = \pm \left(r + \frac{2GM}{c^2} \ln\left|r - \frac{2GM}{c^2}\right| + C_0 \right),
\end{equation}
...
\begin{equation}
c\tilde{t} = ct + \frac{2GM}{c^2} \log\left|r - \frac{2GM}{c^2}\right|,
\end{equation}
