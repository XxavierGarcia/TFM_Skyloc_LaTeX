...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.575\linewidth]{Figures/antennapatterncoordinates.png}
...
% Introducción general al lensing gravitacional
% Analogía con EM, diferencias con GW
% Por qué es relevante para GW astronomy

\section{Geometric optics regime}
\label{sec:geometric_optics}
% Lens equation
% Einstein radius
% Multiple images: tipos (Type I, II, III)
% Magnification
% Time delay

\section{Strong lensing of gravitational waves}
\label{sec:strong_lensing}
% Condición para strong lensing vs weak lensing
% Amplification factor en geometric optics
% Morfología de las imágenes lensadas
% Morse phase y su efecto en la forma de onda

\section{Lensed gravitational wave signals}
\label{sec:lensed_signal}
% Cómo se modifica h(t) bajo lensing
% Relación entre los parámetros de las imágenes
% Parámetros de lensing: magnification ratio, time delay
% Por qué los parámetros aparentes difieren de los intrínsecos

\section{Sky localization of lensed pairs}
\label{sec:sky_localization_lensing}
% Por qué el lensing mejora la sky localization
% Joint PE de dos imágenes
% Hipótesis lensing vs no-lensing (Bayes factor)
% Estado del arte: búsquedas en GWTC
