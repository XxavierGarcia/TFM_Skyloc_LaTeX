...
$ds^{2} = -\frac{1}{4} \left[ 3 \sqrt{1 - \frac{2GM}{c^2 r}}
...
\begin{equation}
ds^2 = -\left(1 - \frac{2GM}{c^2 r}\right) c^2 d\tilde{t}^2 + \frac{4GM}{c}\,
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption[Light cones in Eddington-Finkelstein coordinates]{In Eddington-Finkelstein coordinates the horizon is regular. Ingoing geodesics always remain at $45^\circ$; outgoing ones tilt progressively inward until at $r=2GM/c^2$ they are trapped, and for $r < 2GM$ all light falls toward the singularity. Original 
