...
\begin{description}[leftmargin=1cm]
  ...
  \item[\chapterlink{ch:lensing}{Chapter 3: Gravitational lensing.}] gives an overview of gravitational waves and then ... asmdosamc .... ofmwomo... cas,cs,c,spcs... kc comomaomc gives an overview of gravitational waves and then ... asmdosamc .... ofmwomo... cas,cs,c,spcs... kc comomaomc
  \item[\chapterlink{Simulation_setup}{Chapter 4: Simulation setup and implementation.}] introduces the main results obtained in the course
  \item[\chapterlink{Parameter_estimation_pipeline}{Chapter 5: Parameter estimation pipeline.}] introduces the main results obtained in the course
  \item[\chapterlink{Skyloc}{Chapter 6: Sky localization}] 

  \item[\chapterlink{Conclusions}{Chapter 7: Conclusions.}] introduces the ..
